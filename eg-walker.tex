...
To allow easier comparison of measurements between traces, we have attempted to roughly standardise the sizes of all editing traces to contain approximately 500k inserted characters, equivalent to about 100 printed pages (with the exception of S3, which is approximately twice this size).
